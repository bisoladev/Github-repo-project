function App() {
  return (
    <div className="flex h-screen w-screen  flex-col justify-center bg-bgDark align-middle text-white">
      ...
      <div className="mx-auto flex w-11/12 max-w-[730px] flex-col justify-center rounded-2xl bg-darkCard p-10 align-middle lg:w-4/6">
        <div className="grid grid-cols-[1fr_5fr] gap-10 ">
          <div className=" h-[118px] w-[118px] rounded-full bg-bgDark">
          ...
          <div>
            <div>
              <div className="flex justify-between">
                <div>
                  <h1 className="mb-1 text-2xl font-bold">The Octocat</h1>
                  <a href="/" className="text-base text-primaryColor">
                    @octocat
                  </a>
                </div>{' '}
                <div>
                  <p className="text-[15px]">Joined 25 Jan 2011</p>
                </div>
              </div>
              <div>
            ...
            <div className="mb-10 rounded-[10px] bg-bgDark px-10 py-3">
            ...
            <div className="">
              <ul className="grid grid-cols-2 gap-x-10 gap-y-5 text-[15px]">
                <li className="flex">
                  <svg
                    width="14"
                    height="20"
                  ...
                  <p className="pl-4">San Francisco</p>
                </li>
                <li className="flex">
                  <svg
                    width="20"
                  ...
                  <p className="pl-4">Not Available</p>
                </li>
                <li className="flex">
                  <svg
                    width="20"
