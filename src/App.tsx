        ...
        <div className="grid-rows-auto grid grid-cols-[70px_auto] gap-x-6 gap-y-8 md:grid-cols-[150px_auto]">
          ...
          <div className="col-start-2 col-end-3 row-start-1 row-end-2">
            <div className="flex flex-col  lg:flex-row lg:justify-between">
              ...
              <div>
                <p className="text-[13px] md:text-[15px]">Joined 25 Jan 2011</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-start-1 col-end-3 row-start-3 row-end-4 mb-4 rounded-[10px] bg-bgLight px-6 py-3 dark:bg-bgDark md:px-10 lg:col-start-2">
            <ul className="grid grid-cols-3 gap-5 text-darkText dark:text-white">
              ...
              <li>
                ...
                <p className="text-base font-bold  md:text-[22px]">3938</p>
              </li>
              <li>
                <p className="text-[11px] md:text-[13px]">Following</p>
                <p className="text-base font-bold  md:text-[22px]">9</p>
              </li>
            </ul>
          </div>
          <div className="col-start-1 col-end-3 row-start-4 row-end-5 lg:col-start-2">
            <ul className="grid grid-cols-1 gap-x-10 gap-y-5 text-[15px] min-[500px]:grid-cols-2">
              <li className="flex">
                ...
                <p className="pl-4 text-[13px] md:text-[15px]">San Francisco</p>
              </li>
              <li className="flex">
                <svg
                  width="20"
                ...
                <p className="pl-4 text-[13px] md:text-[15px]">Not Available</p>
              </li>
              <li className="flex">
                <svg
                  width="20"
                ...
                <a href="/" className="pl-4 text-[13px] md:text-[15px]">
                  https://github.blog
                </a>
              </li>
              <li className="flex">
                ...
                <p className="pl-4 text-[13px] md:text-[15px]">@github</p>
              </li>
            </ul>
          </div>
        </div>
